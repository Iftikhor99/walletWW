...
func TestService_FavoritePayment_success(t *testing.T) {
	...
	// CpaBHMBaem nnaTexu
	if !reflect.DeepEqual(favorite, got) {
		t.Errorf("FavoritePayment(): wrong favorite returned = %v", err)
		return
	}
...
/* func TestService_FavoritePayment_fail(t *testing.T) {
	...
	_, err := s.FavoritePayment(uuid.New().String(), "Tcell")	
	...
	if err != ErrFavoriteNotFound {
		t.Errorf("FavoritePayment(): must return ErrFavoriteNotFound, returned = %v", err)
		return
	}
} */
